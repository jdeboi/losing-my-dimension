...
class MacbookAir extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      />
      {/* <video autoPlay muted loop id="myVideo"><source src={videoBackgroundURL} type="video/mp4" ></source>
...
function ContinuousSlider(props) {
  ...
  return (
    ...
    <Grid item xs>
    <Slider value={value} onChange={handleChange} aria-labelledby="continuous-slider" step={0.1} min={0.0} max={2.0} defaultValue={1.0} />
    </Grid>
    <Grid item>
